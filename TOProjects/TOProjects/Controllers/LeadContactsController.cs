...
namespace TOProjects.Controllers
{
    public class LeadContactsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Customer,ContactEmail,ContactFirstName,ContactLastName,ContactMobile,ContactOfficePhone")] LeadContact leadContact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Customer,ContactEmail,ContactFirstName,ContactLastName,ContactMobile,ContactOfficePhone")] LeadContact leadContact)
        {
            if (ModelState.IsValid)
            {
